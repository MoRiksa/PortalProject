Public Class F_Timmy
    Private Sub button_Tambah_Click(sender As Object, e As EventArgs) Handles button_Tambah.Click
        ...
        If Decimal.TryParse(nilaiInput, nilai) AndAlso nilai >= 0 Then
            ' Tambah ke dalam list nilai Timmy
            ListNilaiTimmy.Add(nilai)

            ' Tambah nomor tugas Timmy
            CounterTugasTimmy += 1

            ' Tambahkan ke ListView dengan keterangan "Tugas x : Nilai"
            Dim listItem As New ListViewItem($"Tugas {CounterTugasTimmy} : {nilai}")
            lv_NilaiTimmy.Items.Add(listItem)
